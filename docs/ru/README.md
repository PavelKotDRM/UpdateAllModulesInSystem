...
- Английский язык по умолчанию и русские переводы GUI/CLI; каталог переводов подготовлен для добавления других языков.
...
- `--language <en|ru>` — выбрать язык CLI или временно переопределить сохраненный язык GUI для текущего запуска.
...
- выбор языка в настройках GUI с сохранением между перезапусками;
