...
Кроссплатформенная утилита на Rust для проверки и установки обновлений системных менеджеров, Python-пакетов, инструментов разработки и расширений VS Code-совместимых редакторов. Текущая версия: `0.4.4`.
