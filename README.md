...
- кнопка выбора всех модулей;
- кнопки выбора только системных модулей, только инструментов или только Python;
- кнопка инверсии текущего выбора модулей;
- кнопка быстрого выбора модулей с доступными обновлениями;
- кнопка снятия выбора со всех модулей;
...
- раскрывающиеся блоки с деталями обновлений;
...
- Интеграция `msys2` сейчас использует `pacman`, доступный в `PATH`.
